...
class BuildExe:
    def __init__(self):
        ...
        #Auhor of program
        self.author_name = "Franck Dernoncourt, Xavier Rampino"
        self.author_email = "franck.dernoncourt@gmail.com, xavier.rampino@mailhec.net"
        self.copyright = "Copyright (c) 2010 Franck Dernoncourt, Xavier Rampino"
 
        #Description
        self.project_description = "MIB"
